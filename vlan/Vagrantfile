...
CENTOS_BOX_NAME = 'generic/centos8s'
CENTOS_BOX_VERSION = '4.2.16'
UBUNTU_BOX_NAME = 'ubuntu/focal64'
UBUNTU_BOX_VERSION = '20230515.0.0'

MACHINES = {
  :inetRouter => {
        :box_name => CENTOS_BOX_NAME,
        :box_version => CENTOS_BOX_VERSION,
        :vm_name => "inetRouter",
        :net => [
  ...
  :testClient2 => {
        ...
        :box_version => UBUNTU_BOX_VERSION,
        :vm_name => "testClient2",
        :net => [
                   {adapter: 2, auto_config: false, virtualbox__intnet: "testLAN"},
